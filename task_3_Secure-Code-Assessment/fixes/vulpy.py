...
app = Flask('vulpy')
app.config['SECRET_KEY'] = os.environ.get('FLASK_SECRET_KEY', 'dev-only-insecure-key-do-not-use-in-prod')
...
import os
app.run(debug=os.environ.get('FLASK_DEBUG') == '1', host='127.0.1.1', port=5000)
